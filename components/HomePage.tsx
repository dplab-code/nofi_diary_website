...
const collectionImages = ["/images/editorial/collection-stickers.png", "/images/editorial/collection-themes.png", "/images/app/android-home.png"];
...
export function HomePage({ locale }: { locale: Locale }) {
  const t = copy(locale); const ui = homeUi[locale];
  return <main>
    ...
    <section id="gallery" className="section shell gallerySection"><div className="sectionHeading left"><p className="kicker">{ui.gallery}</p><h2>{t.galleryTitle}</h2></div><div className="galleryVisual"><Image src="/images/editorial/gallery-pages-v2.png" alt="Nine open handmade diaries filled with photographs, paper keepsakes and pressed flowers" fill sizes="100vw" /></div></section>
