...
export default async function ComingSoonPage({ searchParams }: { searchParams: Promise<{ locale?: string | string[] }> }) {
  ...
  return <main className={styles.page}>
    ...
    <aside className={styles.foundNote} aria-label={copy.privateTitle}><Image src="/images/coming-soon/private-by-design-paper.webp" alt="" fill sizes="(max-width: 900px) 94vw, 880px" /><div><p>{copy.privateTitle}</p><span>{copy.privateBody}</span></div></aside>
